...
with_node \
  ...
  --target "/Users/sawyer/gitSync/tm-mobile-cursor/mobile-native-fresh/ios/Pods/Target Support Files/Pods-mobilenativefresh/ExpoModulesProvider.swift" \
  --entitlement "/Users/sawyer/gitSync/tm-mobile-cursor/mobile-native-fresh/ios/mobilenativefresh/mobilenativefresh.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-apple-authentication" "expo-application" "expo-asset" "expo-av" "expo-blur" "expo-constants" "expo-crypto" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linking" "expo-notifications" "expo-speech" "expo-splash-screen" "expo-web-browser"
